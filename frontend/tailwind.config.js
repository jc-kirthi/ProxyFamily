  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'medium': '0 4px 25px -4px rgba(0, 0, 0, 0.12), 0 12px 28px -4px rgba(0, 0, 0, 0.08)',
        'large': '0 8px 40px -8px rgba(0, 0, 0, 0.16), 0 16px 32px -4px rgba(0, 0, 0, 0.12)',
      ...
      backgroundImage: {
        ...
        'gradient-primary': 'linear-gradient(135deg, #3b82f6 0%, #8b5cf6 50%, #d946ef 100%)',
